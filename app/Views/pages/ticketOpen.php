...
<div class="container mx-auto px-4 py-6 overflow-y-auto">
  ...
  <div class="flex items-center justify-between mb-4">
    <div class="relative w-full max-w-md">
      <input type="text" placeholder="Search open tickets..."
    ...
    <table class="min-w-full text-sm">
      ...
      <tbody class="divide-y">
        ...
        <tr>
          ...
          <td class="p-3">Sarfaraz Hussein</td>
          <td class="p-3">
            <span
        ...
        <tr>
          <td class="p-3"><input type="checkbox" /></td>
          <td class="p-3 text-blue-600 hover:underline cursor-pointer">047987</td>
          <td class="p-3 text-gray-600">6/6/25 2:32 PM</td>
          <td class="p-3">
            <div class="flex space-x-2">
              <a href="#" class="text-blue-600 hover:underline">Redis Optimization</a>
              <span class="text-xs ml-1">(9)</span>
              <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M18 10c0 3.866-3.582 7-8 7a8.772 8.772 0 01-3.338-.638l-3.52 1.056a.5.5 0 01-.624-.624l1.056-3.52A7.977 7.977 0 012 10c0-3.866 3.582-7 8-7s8 3.134 8 7z" />
              </svg>
          ...
          <td class="p-3">Sudhir Singh</td>
          <td class="p-3">
            <span
              class="inline-block px-3 py-1 text-xs font-semibold text-blue-600 border border-blue-400 rounded-full">Medium</span>
          </td>
          <td class="p-3">Sudhir Singh</td>
        </tr>
        <!-- Row 3 -->
        <tr>
          <td class="p-3"><input type="checkbox" /></td>
          <td class="p-3 text-blue-600 hover:underline cursor-pointer">063536</td>
          <td class="p-3 text-gray-600">5/26/25 12:47 PM</td>
          <td class="p-3">
            <div class="flex space-x-2">
              <a href="#" class="text-blue-600 hover:underline">Create CRM for Slash.</a>
          ...
          <td class="p-3">
            <span
              class="inline-block px-3 py-1 text-xs font-semibold text-gray-600 border border-gray-400 rounded-full">Low</span>
          </td>
          <td class="p-3">rahul panda</td>
        </tr>
        <!-- Row 4 -->
        <tr>
          <td class="p-3"><input type="checkbox" /></td>
          <td class="p-3 text-blue-600 hover:underline cursor-pointer">063531</td>
          <td class="p-3 text-gray-600">5/26/25 12:01 PM</td>
          <td class="p-3">
            <div class="flex space-x-2">
              <a href="#" class="text-blue-600 hover:underline">Create Ticket Portal for Slash</a>
              <span class="text-xs ml-1">(22)</span>
              <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M18 10c0 3.866-3.582 7-8 7a8.772 8.772 0 01-3.338-.638l-3.52 1.056a.5.5 0 01-.624-.624l1.056-3.52A7.977 7.977 0 012 10c0-3.866 3.582-7 8-7s8 3.134 8 7z" />
              </svg>
        ...
        <tr>
          <td class="p-3"><input type="checkbox" /></td>
          <td class="p-3 text-blue-600 hover:underline cursor-pointer">063538</td>
          <td class="p-3 text-gray-600">5/26/25 12:42 PM</td>
          <td class="p-3">
            <div class="flex space-x-2">
              <a href="#" class="text-blue-600 hover:underline">Video calling feature</a>
              <span class="text-xs ml-1">(10)</span>
              <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M18 10c0 3.866-3.582 7-8 7a8.772 8.772 0 01-3.338-.638l-3.52 1.056a.5.5 0 01-.624-.624l1.056-3.52A7.977 7.977 0 012 10c0-3.866 3.582-7 8-7s8 3.134 8 7z" />
        ...
        <tr>
          <td class="p-3"><input type="checkbox" /></td>
          <td class="p-3 text-blue-600 hover:underline cursor-pointer">063980</td>
          <td class="p-3 text-gray-600">6/6/25 5:53 PM</td>
          <td class="p-3">
            <div class="flex space-x-2">
              <a href="#" class="text-blue-600 hover:underline">No Broker - External Tx& Cx Call Data in Kibana</a>
              <span class="text-xs ml-1">(9)</span>
              <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M18 10c0 3.866-3.582 7-8 7a8.772 8.772 0 01-3.338-.638l-3.52 1.056a.5.5 0 01-.624-.624l1.056-3.52A7.977 7.977 0 012 10c0-3.866 3.582-7 8-7s8 3.134 8 7z" />
